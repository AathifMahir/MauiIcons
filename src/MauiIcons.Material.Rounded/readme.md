...
```xml
<Image Aspect="Center" mi.MauiIcon.Value="{mi:MaterialRounded Icon=ABC}"/>

<Button mi.MauiIcon.Value="{mi:MaterialRounded Icon=AddRoad}"/>

<ImageButton mi.MauiIcon.Value="{mi:MaterialRounded Icon=AddRoad}"/>
```
...
`xaml`
```xml
<Entry mi:MauiIcon.Value="{mi:MaterialRounded Icon=ABC, TargetName='Text'}"/>

<SearchBar mi:MauiIcon.Value="{mi:MaterialRounded Icon=AddRoad, TargetName='Placeholder'}"/>
```
...
<MaterialRounded:MauiIcon Icon="ABC"/>
```
...
<mi:MauiIcon Icon="{mi:MaterialRounded ABC}"/>
```
...
```xml
/// Old
<Image Aspect="Center" Source="{mi:MaterialRounded Icon=AddRoad}"/>
...
<Style x:Key="ButtonStyle" TargetType="Button">
       <Setter Property="mi:MauiIcon.Value" Value="{mi:MaterialRounded Icon=ABC}" />
</Style>
