...
public static class BuilderExtensions
{
	...
	/// <returns><see cref="MauiAppBuilder"/> initialized for <see cref="FontAwesome"/></returns>
    /// 
    public static MauiAppBuilder UseFontAwesomeMauiIcons(this MauiAppBuilder builder)
    {
