...
```xml
<Image Aspect="Center" mi.MauiIcon.Value="{mi:FontAwesomeBrand Icon=XTwitter}"/>

<Button mi.MauiIcon.Value="{mi:FontAwesomeBrand Icon=Deezer}"/>

<ImageButton mi.MauiIcon.Value="{mi:FontAwesomeBrand Icon=Unity}"/>
```
...
`xaml`
```xml
<Entry mi:MauiIcon.Value="{mi:FontAwesomeBrand Icon=Hashtag, TargetName='Text'}"/>

<SearchBar mi:MauiIcon.Value="{mi:FontAwesomeBrand Icon=XTwitter, TargetName='Placeholder'}"/>
```
...
```xml
<mi:MauiIcon Icon="{mi:FontAwesomeBrand Unity}" OnPlatforms="WinUI, Android, MacCatalyst"/>
<mi:MauiIcon Icon="{mi:FontAwesomeBrand Deezer}" OnIdioms="Desktop, Phone, Tablet"/>
<mi:MauiIcon Icon="{mi:FontAwesomeBrand XTwitter}" OnPlatforms="Android" OnIdioms="Phone"/>
```

`C#`
```csharp
new MauiIcon().Icon(FontAwesomeBrandIcons.Unity).OnPlatforms(new List<string>{"WinUI", "Android"});
new MauiIcon().Icon(FontAwesomeBrandIcons.Deezer).OnIdioms(new List<string>{"Desktop", "Phone"});
new MauiIcon().Icon(FontAwesomeBrandIcons.XTwitter).OnPlatforms(new List<string>{"WinUI", "Android"}).OnIdioms(new List<string>{"Desktop", "Phone"});
```
...
```xml
/// Old
<Image Aspect="Center" Source="{mi:FontAwesomeBrand Icon=Unity}"/>

// New
<Image Aspect="Center" mi.MauiIcon.Value="{mi:FontAwesomeBrand Icon=Unity}"/>
```
...
<Style x:Key="ButtonStyle" TargetType="Button">
       <Setter Property="mi:MauiIcon.Value" Value="{mi:FontAwesomeBrand Icon=Deezer}" />
</Style>
