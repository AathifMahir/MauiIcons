...
```xml
<Image Aspect="Center" mi.MauiIcon.Value="{mi:FluentFilled Icon=Accessibility48Filled}"/>

<Button mi.MauiIcon.Value="{mi:FluentFilled Icon=AppFolder48Filled}"/>

<ImageButton mi.MauiIcon.Value="{mi:FluentFilled Icon=AppFolder48Filled}"/>
```
...
`xaml`
```xml
<Entry mi:MauiIcon.Value="{mi:FluentFilled Icon=Accessibility48Filled, TargetName='Text'}"/>

<SearchBar mi:MauiIcon.Value="{mi:FluentFilled Icon=AppFolder48Filled, TargetName='Placeholder'}"/>
```
...
<Style x:Key="ButtonStyle" TargetType="Button">
       <Setter Property="mi:MauiIcon.Value" Value="{mi:FluentFilled Icon=AppFolder48Filled}" />
</Style>
