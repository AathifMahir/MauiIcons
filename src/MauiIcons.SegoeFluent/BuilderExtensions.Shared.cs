...
public static class BuilderExtensions
{
	...
	/// <returns><see cref="MauiAppBuilder"/> initialized for <see cref="SegoeFluent"/></returns>
    /// 
    public static MauiAppBuilder UseSegoeFluentMauiIcons(this MauiAppBuilder builder)
    {
