...
<Button mi:MauiIcon.Value="{mi:Cupertino Icon=Airplane}"/>

<ImageButton mi:MauiIcon.Value="{mi:Cupertino Icon=AppBadge}">
```
...
`xaml`
```xml
<Entry mi:MauiIcon.Value="{mi:Cupertino Icon=AntFill, TargetName='Text'}"/>

<SearchBar mi:MauiIcon.Value="{mi:Cupertino Icon=Airplane, TargetName='Placeholder'}"/>
```
...
```xml
/// Old
<Image Aspect="Center" Source="{mi:Cupertino Icon=Airplane}"/>

// New
<Image Aspect="Center" mi.MauiIcon.Value="{mi:Cupertino Icon=Airplane}"/>
```
...
<Style x:Key="ButtonStyle" TargetType="Button">
       <Setter Property="mi:MauiIcon.Value" Value="{mi:Cupertino Icon=Airplane}" />
</Style>
