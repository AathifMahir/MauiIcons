[assembly: XmlnsDefinition(Constants.XamlNamespace, Constants.MauiIconsNamespacePrefix + nameof(MauiIcons.Material))]
...
static class Constants
{
    ...
    internal static readonly string RegularFontFamily = "MaterialIcons";
